...
import {
  ...
  log,
  useBackPress,
} from '@arpitmalik832/react-ts-rollup-swc-monorepo-library';
import {
  configureStore,
  createSlice,
  EnhancedStore,
...
jest.mock('@arpitmalik832/react-ts-rollup-swc-monorepo-library', () => ({
  __esModule: true,
  ...jest.requireActual<object>(
    '@arpitmalik832/react-ts-rollup-swc-monorepo-library',
  ),
  log: jest.fn(),
