...
import {
  ...
  log,
  useBackPress,
} from '@arpitmalik832/react-ts-vite-swc-monorepo-library';
import {
  configureStore,
  createSlice,
  EnhancedStore,
...
jest.mock('@arpitmalik832/react-ts-vite-swc-monorepo-library', () => ({
  __esModule: true,
  ...jest.requireActual<object>(
    '@arpitmalik832/react-ts-vite-swc-monorepo-library',
  ),
  log: jest.fn(),
